...
const platformConfig: Record<
  Platform,
  { label: string; bgClass: string; icon: (props: IconProps) => ReactNode }
> = {
  tiktok: { label: "TikTok", bgClass: "bg-tiktok", icon: TikTokIcon },
  instagram: {
    label: "Instagram",
    bgClass: "bg-instagram",
    icon: InstagramIcon,
  },
  youtube: { label: "YouTube", bgClass: "bg-youtube", icon: YouTubeIcon },
  other: { label: "Other", bgClass: "bg-muted", icon: OtherIcon },
};
